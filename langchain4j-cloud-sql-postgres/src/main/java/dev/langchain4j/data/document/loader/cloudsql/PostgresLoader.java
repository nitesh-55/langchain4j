package dev.langchain4j.data.document.loader.cloudsql;
...
public class PostgresLoader {
    ...
    public static class Builder {
        ...
        /**
         * Constructs a new Builder with the specified Postgres engine.
         *
         * @param engine The Postgres engine to use.
         */
